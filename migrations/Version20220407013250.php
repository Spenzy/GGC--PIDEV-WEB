 ...
 */
final class Version20220407013250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE idClient idClient INT NOT NULL, CHANGE nbrAvertissement nbrAvertissement INT NOT NULL, CHANGE ban ban INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE nbrAvertissement nbrAvertissement INT DEFAULT NULL, CHANGE ban ban INT DEFAULT NULL, CHANGE idClient idClient INT AUTO_INCREMENT NOT NULL');
