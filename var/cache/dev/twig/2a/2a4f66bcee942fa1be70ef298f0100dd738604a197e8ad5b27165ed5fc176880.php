...
class __TwigTemplate_a2bc5d4dcd6a21c098b179ec70c907afcbda82683edf87d2a627d09b541e9377 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["commande"]) {
            ...
            echo "</td>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["commande"], "adresse", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["commande"], "prix", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                <td>";
            // line 25
            echo ((twig_get_attribute($this->env, $this->source, $context["commande"], "livree", [], "any", false, false, false, 25)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 26
            ((twig_get_attribute($this->env, $this->source, $context["commande"], "datecommande", [], "any", false, false, false, 26)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["commande"], "datecommande", [], "any", false, false, false, 26), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>
                    <a href=\"";
            // line 28
    ...
    <table class=\"table\">
        ...
        {% for commande in commandes %}
            <tr>
                ...
                <td>{{ commande.prix }}</td>
                <td>{{ commande.livree ? 'Yes' : 'No' }}</td>
                <td>{{ commande.datecommande ? commande.datecommande|date('Y-m-d') : '' }}</td>
                <td>
                    <a href=\"{{ path('app_commande_show', {'idcommande': commande.idcommande}) }}\">show</a>
                    <a href=\"{{ path('app_commande_edit', {'idcommande': commande.idcommande}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "commande/index.html.twig", "C:\\Users\\Mr\\Desktop\\3ème année\\2 sem\\pidev\\GGC--PIDEV-WEB\\templates\\commande\\index.html.twig");
    }
}
