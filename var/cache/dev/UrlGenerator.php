...
return [
    ...
    'loginnnn' => [[], ['_controller' => 'App\\Controller\\AdminController::indexLogin'], [], [['text', '/loginnnn']], [], []],
    'app_loginm' => [[], ['_controller' => 'App\\Controller\\AdminController::login'], [], [['text', '/loginm']], [], []],
    'app_admin_pubarchive' => [[], ['_controller' => 'App\\Controller\\AdminController::forumArchive'], [], [['text', '/forum/archive']], [], []],
    'app_admin_pubnonarchive' => [[], ['_controller' => 'App\\Controller\\AdminController::forumNonArchive'], [], [['text', '/forum/NonArchive']], [], []],
    'app_forum_archive' => [['idpublication'], ['_controller' => 'App\\Controller\\AdminController::archiver'], [], [['variable', '/', '[^/]++', 'idpublication'], ['text', '/forum']], [], []],
    ...
    'message' => [[], ['_controller' => 'App\\Controller\\BootController::messageAction'], [], [['text', '/messagebot']], [], []],
    'homepage' => [[], ['_controller' => 'App\\Controller\\BootController::indexAction'], [], [['text', '/messaagebot']], [], []],
    'chatframe' => [[], ['_controller' => 'App\\Controller\\BootController::chatframeAction'], [], [['text', '/chatframebot']], [], []],
    'app_client_index' => [[], ['_controller' => 'App\\Controller\\ClientController::index'], [], [['text', '/client/']], [], []],
    'app_client_new2' => [[], ['_controller' => 'App\\Controller\\ClientController::new2'], [], [['text', '/client/new2']], [], []],
    'app_client_show' => [['idclient'], ['_controller' => 'App\\Controller\\ClientController::show'], [], [['variable', '/', '[^/]++', 'idclient'], ['text', '/client']], [], []],
    'app_client_edit' => [['idclient'], ['_controller' => 'App\\Controller\\ClientController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'idclient'], ['text', '/client']], [], []],
    'app_client_delete' => [['idclient'], ['_controller' => 'App\\Controller\\ClientController::delete'], [], [['variable', '/', '[^/]++', 'idclient'], ['text', '/client']], [], []],
    ...
    'app_moderateur_index' => [[], ['_controller' => 'App\\Controller\\ModerateurController::index'], [], [['text', '/moderateur/']], [], []],
    'app_moderateur_new' => [[], ['_controller' => 'App\\Controller\\ModerateurController::new'], [], [['text', '/moderateur/new']], [], []],
    'app_moderateur_show' => [['idModerateur'], ['_controller' => 'App\\Controller\\ModerateurController::show'], [], [['variable', '/', '[^/]++', 'idModerateur'], ['text', '/moderateur']], [], []],
    'app_moderateur_edit' => [['idModerateur'], ['_controller' => 'App\\Controller\\ModerateurController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'idModerateur'], ['text', '/moderateur']], [], []],
    'app_moderateur_delete' => [['idModerateur'], ['_controller' => 'App\\Controller\\ModerateurController::delete'], [], [['variable', '/', '[^/]++', 'idModerateur'], ['text', '/moderateur']], [], []],
    ...
    'app_personne_index' => [[], ['_controller' => 'App\\Controller\\PersonneController::index'], [], [['text', '/personne/']], [], []],
    'app_personne_new' => [[], ['_controller' => 'App\\Controller\\PersonneController::new'], [], [['text', '/personne/new']], [], []],
    'app_personne_show' => [['idPersonne'], ['_controller' => 'App\\Controller\\PersonneController::show'], [], [['variable', '/', '[^/]++', 'idPersonne'], ['text', '/personne']], [], []],
    'app_personne_edit' => [['idPersonne'], ['_controller' => 'App\\Controller\\PersonneController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'idPersonne'], ['text', '/personne']], [], []],
    'app_personne_delete' => [['idPersonne'], ['_controller' => 'App\\Controller\\PersonneController::delete'], [], [['variable', '/', '[^/]++', 'idPersonne'], ['text', '/personne']], [], []],
    ...
    'app_produit_note' => [['reference'], ['_controller' => 'App\\Controller\\ProduitController::affecterNote'], [], [['text', '/note'], ['variable', '/', '[^/]++', 'reference'], ['text', '/produit']], [], []],
