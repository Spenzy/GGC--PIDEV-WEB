...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 09 avr. 2022 à 20:18
...
ALTER TABLE `commande`
  ADD CONSTRAINT `fk_client_commande` FOREIGN KEY (`idClient`) REFERENCES `client` (`idClient`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `lignecommande`
--
ALTER TABLE `lignecommande`
  ADD CONSTRAINT `fk_ligne_commande` FOREIGN KEY (`idCommande`) REFERENCES `commande` (`idCommande`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_ligne_produit` FOREIGN KEY (`idProduit`) REFERENCES `produit` (`reference`) ON DELETE CASCADE ON UPDATE CASCADE;
