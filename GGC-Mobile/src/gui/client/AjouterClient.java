 ...
 * @author Dell
 */
public class AjouterClient extends Form {
       public AjouterClient(Form previous) {
                    ...
                    new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent evt
                            ...
                            if ((tf_nom.getText().length() == 0) || (tf_prenom.getText().length() == 0) || (tf_telephone.getText().length() == 0) || (tf_email.getText().length() == 0) || (tf_password.getText().length() == 0)) {
                                ...
                                try {
                                    Client p = new Client(tf_nom.getText(), tf_prenom.getText(), date.getDate(), tf_email.getText(), Integer.parseInt(tf_telephone.getText()), tf_password.getText());
                                    if (ServiceClient.getInstance().addClient(p)) {
