 ...
 * @author dell
 */
public class DetailsEventClient extends Form {
    ...
    public DetailsEventClient(Evenement p, Form previous) {
...
//        Label nbr=new Label("nbrpart : "+p.getNbrParticipant());
        ...
        addAll(tit,desc,loc);
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e -> new AffichEventClient(previous).showBack());
